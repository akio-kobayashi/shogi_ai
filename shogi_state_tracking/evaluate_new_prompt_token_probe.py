...
def parse_args():
    ...
    parser.add_argument("--max-moves", type=int, default=128); parser.add_argument("--device", default="auto")
...
def main():
    ...
    config = ModelConfig(**payload["config"]); model = build_model("vanilla", config).to(device)
