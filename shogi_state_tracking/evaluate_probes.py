...
HEADLINE_STATE_METRICS = (
    ...
    "board_occupancy_balanced_accuracy",
    "board_occupancy_precision",
    "board_occupancy_recall",
    "board_occupancy_f1",
    "board_piece_accuracy_on_occupied",
    "board_piece_on_occupied_balanced_accuracy",
    "board_piece_on_occupied_macro_precision",
    "board_piece_on_occupied_macro_recall",
    "board_piece_on_occupied_macro_f1",
    "hand_exact_match",
    "hand_nonzero_accuracy",
    "hand_nonzero_balanced_accuracy",
    "hand_nonzero_precision",
    "hand_nonzero_recall",
    "hand_nonzero_f1",
    "turn_accuracy",
    "turn_balanced_accuracy",
    "turn_precision",
    "turn_recall",
    "turn_f1",
